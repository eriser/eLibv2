#ifndef MODRESONANTHPF_H_
#define MODRESONANTHPF_H_
...
namespace eLibV2
{
    namespace Effect
    {
        ...
        */
        class ResonantHPF : public Base::BaseEffect
        {
        public:
            enum
            {
        ...
        public:
            ResonantHPF(std::string name = "ResonantHPF") :
                Base::BaseName(name)
            {
                Init();
            }

            virtual ~ResonantHPF(void)
            {
                if (mInternalBiquad)
