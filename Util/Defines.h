...
#define LOG_CLASS_INSTRUMENT    LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_6
#define LOG_CLASS_LOADER        LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_7
#define LOG_CLASS_MIDI          LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_8
#define LOG_CLASS_PLUGIN        LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_9
#define LOG_CLASS_UTIL          LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_10
#define LOG_CLASS_VSTBASE       LOG_CLASS_ELIB | ModuleLogger::LOGGING_CLASS_11
